        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 4 }}>
            {days.map((date, i) => {
              ...
              return (
                <div key={i} style={{ minHeight: 60, border: "1px solid #ddd", padding: 4, boxSizing: "border-box" }}>
                    ...
                    {dateStr &&
                      groupedEvents[dateStr]?.map((ev) => (
                        <div
                          key={ev.id}
                          style={{
                            backgroundColor: getColor(ev.owner),
                            padding: 2,
                            borderRadius: 4,
                            marginTop: 2,
                            fontSize: 12,
        ...
        <div style={{ flex: 1, padding: 16, overflowY: "auto" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0 }}>
            {events.map((ev) => (
              ...
              >
                <span>
                  <strong>{ev.date}:</strong> {ev.title} <small>({ev.owner})</small>
                </span>
                <button
